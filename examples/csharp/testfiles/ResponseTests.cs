...
/*    public static TheoryData<ListenOptions> ConnectionMiddlewareData => new TheoryData<ListenOptions>
    ...
    {
//        Assert.True(totalReceived < totalBytes);
//        x = $"{nameof(AssertStreamAborted)} Stream completed successfully.";
//        Assert.True($"{nameof(AssertStreamAborted)} Stream completed successfully.");
