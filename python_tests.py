...
def test_grammar(gdata):
    ...
    print('Java lexer run completed.')
    ...
    print('Java parser run completed.')

    # Run javacc to create the Python lexer and parser

    cmd = ['java', '-jar', 'javacc.jar', '-q', '-lang', 'python', gf]
    p = subprocess.run(cmd)
    if p.returncode:
    ...
    print('Python lexer run completed.')
    ...
    print('Python parser run completed.')
